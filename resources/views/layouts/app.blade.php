    ...
    <header id="header" class="header fixed-top accent-background">
            ...
            <div class="container d-flex justify-content-center justify-content-md-between">
                <div class="contact-info d-flex align-items-center">
                    <i class="bi bi-envelope d-flex align-items-center"><a
                            href="mailto:contact@example.com">astros21@gmail.com.br</a></i>
                    <i class="bi bi-phone d-flex align-items-center ms-4"><span>99 9999999</span></i>
                </div>
        ...
        <style>
            ...
            main>.container {
                ...
                max-width: 1200px;
                /* Defina o tamanho máximo do conteúdo */
            }
        </style>
    @endif
